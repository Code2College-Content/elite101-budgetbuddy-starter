...
- The `average_balance` feature added in `lesson/12-start` now has tests:
  `tests/test_reports.py` covers the empty-history, single-balance, and
  several-balances cases.
